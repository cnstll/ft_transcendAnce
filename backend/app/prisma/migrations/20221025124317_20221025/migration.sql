/*
  ...
  - A unique constraint covering the columns `[twoFactorAuthenticationSecret]` on the table `users` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "users_twoFactorAuthenticationSecret_key" ON "users"("twoFactorAuthenticationSecret");
