/*
  ...
  - A unique constraint covering the columns `[twoFactorAuthentificationSecret]` on the table `users` will be added. If there are existing duplicate values, this will fail.
...
ADD COLUMN     "twoFactorAuthentificationSecret" TEXT,
...
-- CreateIndex
CREATE UNIQUE INDEX "users_twoFactorAuthentificationSecret_key" ON "users"("twoFactorAuthentificationSecret");
