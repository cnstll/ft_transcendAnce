...
const putFriendUpdate = (user: { target: string | undefined, friends: boolean }) => axios.put<null>(`${apiUrl}/user/update-friendship`, user, { withCredentials: true }).then((res) => res.data)
