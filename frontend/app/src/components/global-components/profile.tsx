...
function Profile () {
    ...
    <div>
        <Background background={BackgroundGeneral}>
            ...
            <div className="flex flex-row gap-10 sm:gap-10 md:gap-14 lg:gap-20 px:2 lg:px-5 justify-center mt-6 text-white text-3xl">
                <SideBox>
                    <div className="flex justify-center">
                        <img className="w-6 h-6 sm:w-11 sm:h-11 md:w-12 md:h-12 lg:w-14 lg:h-14 xl:w-16 xl:h-16 rounded-full"
                    ...
                    <div className="flex flex-col flex-wrap gap-6 mt-20 text-[10px] sm:text-xs md:text-sm lg:text-base">
